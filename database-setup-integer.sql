...
-- Primary Key: INTEGER (not UUID as per rules)
CREATE TABLE users (
...
-- ===========================================
-- SAMPLE DATA FOR TESTING - INTEGER IDs
-- ===========================================
...
-- ===========================================
-- VERIFY TABLES AND DATA - INTEGER PRIMARY KEYS
-- ===========================================
...
SELECT 'USERS TABLE DATA (INTEGER IDs):' as info;
SELECT id, email, name, phone, created_at FROM users ORDER BY id;

SELECT 'DRUG_TRIALS TABLE DATA (INTEGER IDs):' as info;
